...
const user = {
  name: 'G Hemanth',
  email: 'hemumani73@gmail.com',
  imageUrl:
    'https://res.cloudinary.com/den6snpmc/image/upload/v1692017246/portrait_xrrfc0.jpg',
}
const navigation = [
...
export default function ProfileBar() {
  ...
  const scrollToContactUs = () => {
    // Use JavaScript to scroll to the ContactUs component
                              ...
                              <Menu.Item key={item.name}>
                                {({ active }) => (
                                  <a
                                    ...
                                    onClick={item.name === 'Contact Us' ? scrollToContactUs : null}
                                  >
                                    {item.name}
                                  </a>
                                )}
